...
export default function HospitalCreateReservation() {
    const { currentLatitude, currentLongitude } = useGetCurrentLatLng();
    const { user } = useAuthContext();
    // Use Location to get state from Link
    const location = useLocation();

    const { data, loading } = useHospitalProfileInfo(user, "");
    console.log("HOSPITAL DATA:", data);
    const { hospital } = data;
    console.log("HOSPITAL DATA-> hospital:", hospital);
    ...
    async function handleConfirmation(e) {
        ...
        formDataObject["hospitalId"] = hospital._id;
        ...
        try {
            ...
            toast.success(
                "Booking Successful !! Navigating to previous page...",
                {
