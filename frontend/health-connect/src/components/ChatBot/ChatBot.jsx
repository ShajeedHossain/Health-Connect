...
const ChatBot = () => {
  ...
  const fetchMessages = async (conversationId, receiver) => {
    const receiverId = receiver?.[`${swapUserType[newUser?.type]}`]._id;
    ...
    console.log(resData ? "HELLO" : "BYTE");
            ...
            users.map((singleUser, index) => {
              ...
              return (
                ...
                >
                  <div
                    className="cursor-pointer flex items-center"
                    onClick={() => fetchMessages("new", singleUser)}
                  >
                    <div>
                      <img
                        src={Img1}
                    ...
                    <div className="ml-6">
                      ...
                      <p className="text-sm font-light text-gray-600">
                        {singleUser?.[`${swapUserType[newUser?.type]}`]?.email}
                      </p>
                    </div>
                  </div>
                </div>
