    ...
    <section className={classes["headerPart"]}>
          ...
          {newUser && (
            <>
              {newUser.type === "hospital" ? (
                <Link to="/hospital-dashboard/" className={classes["option"]}>
                  <h3>Dashboard</h3>
                </Link>
              ) : newUser.type === "patient" ? (
                <Link className={classes["option"]} to="/dashboard/appointment">
                  Dashboard
                </Link>
              ) : (
                <Link className={classes["option"]} to="/doctor-dashboard">
                  Dashboard
                </Link>
              )}
          ...
          {!user && !newUser ? (
            <>
              ...
              <Link to="/login" className={classes["optionBtn"]}>
                <h3 className={classes["BookNowBtntext"]}>Login</h3>
              </Link>
              <Link to="/signup" className={classes["optionBtn"]}>
                <h3 className={classes["BookNowBtntext"]}>Signup</h3>
              </Link>
            </>
          ) : (
            <Link onClick={logout} className={classes["optionBtn"]}>
              <h3 className={classes["BookNowBtntext"]}>Logout</h3>
            </Link>
          )}

          <a href="#" className={classes["menubutton"]}>
            <img src="/health-connect-frontend/images/menu.png" alt="" />
          </a>
        </div>
      </div>
      <div
      ...
      >
        ...
        <a href="#" className={classes["closebutton"]}>
          <img src="/health-connect-frontend/images/close.png" alt="" />
        </a>
        ...
        <div className={classes["bannerwrite"]}>
          <span>
            ...
            <h3 className={classes["bannertitle"]}>
              A pioneering web application that seamlessly connects patients and
              doctors,
              <br />
              revolutionizing healthcare access. Say goodbye to overcrowded
              hospitals
            </h3>
          </span>
