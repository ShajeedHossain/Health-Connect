...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      const signupResult = await signup(email, password, fullName, address);
        ...
        <div className="login-signup-form">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              required
            />
            {(error || err) && <pre className="error">{error || err}</pre>}
            {/* Display error message */}
            <input disabled={isLoading} type="submit" value="Signup" />
          </form>
        </div>
      </section>
