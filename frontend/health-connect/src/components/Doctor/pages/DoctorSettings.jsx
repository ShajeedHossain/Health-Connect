...
export default function DoctorSettings() {
    ...
    const { doctorInfo, doctorLoading, doctorError } =
        useDoctorProfileInfo(user);
            ...
            <div>
                ...
                >
                    ...
                    <div className={classes["date-gender"]}>
                        <div>
                            ...
                            <input
                                ...
                                id="dob"
                                value={
                                    formatDateAndTime(prevDoctorData?.dob).date
                                }
                                onChange={(e) => {
                                    handleChange(e);
                                }}
                    ...
                    <input
                        ...
                        value={prevDoctorData?.specializations
                            ?.map((sp) => sp)
                            .join(", ")}
                        onChange={(e) => {
                            handleChange(e);
                    ...
                    <div className={classes["date-gender"]}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={convertDateToTime(
                                    prevDoctorData?.morning_shift_time
                                )}
                                onChange={(e) => {
                                    handleChange(e);
                                }}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="evening shift time"
                                placeholder="Evening Shift Time ( HH:MM ) format"
                                value={convertDateToTime(
                                    prevDoctorData?.evening_shift_time
                                )}
                                onChange={(e) => {
                                    handleChange(e);
                                }}
