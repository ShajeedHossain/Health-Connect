...
export default function SingleHospital({ hospital }) {
  ...
  const { hospitalName, email, address, cabins, beds } = hospital;
  return (
    <div className={`${classes["BookHospitalCard"]} dashboard-card`}>
      <table>
        ...
        <tr>
          ...
          <td>
            {beds?.reduce((accumulator, currentBed) => {
              return accumulator + (currentBed.remaining || 0);
            }, 0)}
          </td>
        </tr>
        <tr>
          ...
          <td>
            {cabins?.reduce((accumulator, currentCabin) => {
              return accumulator + (currentCabin.remaining || 0);
            }, 0)}
          </td>
        </tr>
        <tr>
